...
class CarmiObserver extends React.Component {
    ...
    shouldComponentUpdate(nextProps) {
        ...
        return nextProps.dirtyFlag !== dirtyFlag || nextProps.dirtyFlag[0] || nextProps.overrides !== overrides;
    }
    ...
    render() {
        const { dirtyFlag, descriptor, overrides, token } = this.props;
        dirtyFlag[0] = false;
...
function createNewElement(observerProps, originalProps) {
    ...
    const compProps = {
        ...extraProps,
        ...observerProps,
        $internal: { originalProps, observerProps },
    };
